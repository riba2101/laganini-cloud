 ...
 */
public class PostgreSqlR2dbcQuery<T>
        extends AbstractPostgreSqlR2dbcQuery<T, PostgreSqlR2dbcQuery<T>>
{
    ...
    public PostgreSqlR2dbcQuery<T> clone(R2dbcConnectionProvider connectionProvider) {
        PostgreSqlR2dbcQuery<T> q = new PostgreSqlR2dbcQuery<T>(
                connectionProvider,
                getConfiguration(),
                getMetadata().clone()
        );
