...
import com.laganini.cloud.storage.r2dbc.querydsl.r2dbc.AbstractR2dbcQuery;
 ...
 * @see R2dbcQuery
 */
public abstract class AbstractPostgreSqlR2dbcQuery<T, C extends AbstractPostgreSqlR2dbcQuery<T, C>>
        extends AbstractR2dbcQuery<T, C>
{

    public AbstractPostgreSqlR2dbcQuery(
     ...
     */
    public C noWait() {
        QueryFlag noWaitFlag = configuration
                .getTemplates()
                .getNoWaitFlag();
    ...
    public C of(RelationalPath<?>... paths) {
        ...
        for (RelationalPath<?> path : paths) {
            ...
            builder.append(getConfiguration()
                                   .getTemplates()
