...
import org.laganini.cloud.storage.audit.provider.jpa.EnableLaganiniCloudStorageAuditJpa;
...
@EnableLaganiniCloudStorageJpa(basePackages = {"test.app.jpa", "org.laganini.cloud.storage.audit.provider.jpa"})
